        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="end-time" className="block text-sm font-medium text-gray-700">Fim</label>
                <input type="time" id="end-time" value={endTime} onChange={e => setEndTime(e.target.value)} required className="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
              </div>
            </div>
            <div>
